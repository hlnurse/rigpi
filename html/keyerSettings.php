...
//});
			...
			function setMyKeyerFields()
			{
				...
				if (document.getElementById("potCheck").checked==true){
					var spe=1;
				}else{
					var spe=0;					
				}
				...
				$.post("/programs/SetSettings.php", {field: "WKMode", radio: tMyRadio, data: tModeVal, table: "Keyer"});
				   ...
				   $.post("/programs/SetSettings.php", {field: "WKSpeedPotEnable", radio: tMyRadio, data: spe, table: "Keyer"});
		   ...
		   function getMyKeyerFields()
		   {
			...
			$.post('/programs/GetSetting.php',{radio: tMyRadio, field: 'WKSpeedPotEnable', table: 'Keyer'}, function(response){
				...
				if ((tCheck & 1)==1){
					document.getElementById("potCheck").checked=true;
				}else{
					document.getElementById("potCheck").checked=false;
				}
			});
...
<body class="body-black-scroll" id="keyersettings" >
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-4  text-center text-spacer">
				 <div class="form-check form-check-inline">
			 	<label class="form-check-label  text-white text-center">
			 		<input type="checkbox" data-index="20" id="potCheck" class="form-check-input">
				 		Use Pot for speed control
			 		</input>
			 	</label>
			 </div>
		</div>
			 <div class="col-md-4 text-center text-spacer">
				 <div class="form-check form-check-inline">
				 <label class="form-check-label  text-white text-center">
				 <input type="checkbox" data-index="21" id="pttOnCheck" class="form-check-input">
