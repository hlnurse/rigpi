	...
	class CWUDPServer
	{
		...
		public function __construct($bind_ip,$port, $tRadio, $tUser)
		{
			...
			if ($port!=0)
			{
				...
				socket_bind($this->master_socket,0,$this->config["port"]) or die("Issue Binding");
			}
		}
		...
		*/
		public function loop_once()
		{
			...
			$r=15;
			$i="0";
			$input = socket_recvfrom($this->master_socket, $buf,$r,0,$i,$p);  //sock,buf,#chars,flags,fromIP,fromPort
			$tdat=explode(" ",$buf);
