	...
	class Membership {
		function check_user($un,$pwd){
			...
			if ($ensure_credentials){
				...
				$_SESSION["firstUse"]=1; 
				error_log("<W>" . date('Y-m-d H:i:s', time())." ".$ip." OK username: ".$un." password: ".$pass. "\r\n",3,"/var/log/rigpi-access.log");
				if ($call=="ADMIN"){
				...
				error_log("<W>" . date('Y-m-d H:i:s', time())." ".$ip." Invalid login as ".$un." from ". $ip. "\r\n",3,"/var/log/rigpi-access.log");
				return "NG";
			}
		}
