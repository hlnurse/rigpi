...
if ($db->count > 0) {
	foreach ($row as $line){
		$rad=$line["MODEL"];
		$data=$data . "<div class='myrad' id='$rad'><li><a class='dropdown-item rotors' id='$rad' href='#'>" . $rad . "</a></li></div>\n\r";
	}
}else{
	$data="<div class='myrad' id='$rad'><li><a class='dropdown-item rotors' id='$rad' href='#'>Not found</a></li></div>\n\r";
}
echo $data;
