...
<head>
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $.post('/programs/GetSelectedRadio.php',{un:tUserName}, function(response)
                {
					...
					$(document).on('click', '#bandCanvas', function(e){
						...
						var oF=(cP-fTune)*100;
						var tFreq=getBSHiFreq(tBand)+oF;
            ...
            function paintBSSpots(bandx){
                $.post('/programs/GetBandSpotter.php',{radio:tMyRadio,band:bandx,folder:'Inbox',need:tNeed}, function(response){
 					var aRSpots=response.split("top: ");
 					var aLSpots=response.split("top='");
 					var arr1;
 					var arr2;
					for(var i=1,len=aRSpots.length;i<len;i++){
            ...
            function getBSFreq(bandx)
            {
            	$.post("/programs/GetBSFrequencies.php",{band: bandx},function(response){
	            	var freqs=response;
