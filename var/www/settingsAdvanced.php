...
//			    });
			...
			$(document).on('click', '.myMacroBank', function() {
				var text = $(this).text();
  				$("#curMacroBank").val(text);
			});
...
//					}
				...
				$.post('/programs/GetInterface.php', {field:'MacroBank',radio:tMyRadio}, function(response) {
		  			$('#curMacroBank').val(response);
	  			});
						...
						var noPoll=document.getElementById("splitCheck").checked;
					  	...
					  	$.post("/programs/SetMyRadio.php", {m: $("#curManu").val(), 
	                        ...
	                        slp:$("#curSlavePort").val(), slb:$("#curSlaveBaud").val(), slc:$("#curSlaveCommand").val(), sv:tShowVideo, pl:tMyPTTLatch },
						  	...
						  	$.post("/programs/SetSettings.php", {field:"MacroBank", data:$("#curMacroBank").val(), radio:tMyRadio, 
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-4 text-spacer">
				<div class="input-group">
					<div class="input-group-prepend">
						<span class="input-group-text radio-group-addon">Macro Bnk</span>
					</div>
					<input type="text" class="form-control disable-text" readonly id="curMacroBank"  title="Macro Bank Select" aria-lable="bank" aria-describedby="bank-addon">
				    <span class="input-group-btn">
			            <div class="dropdown">
						    <button class="btn btn-primary dropdown-toggle" id="macroBankSel" data-size="3" type="button"  title="Macro Bank List" data-toggle="dropdown"><i class="fas fa-list-alt fa-lg"></i>
						    </button>
							<div class="dropdown-menu dropdown-menu-right menu-scroll" id='macroBank' aria-labelledby="macroSelectButton">
								<div class='myMacroBank' id='b1'><li><a class='dropdown-item' href='#'>1</a></li></div>
								<div class='myMacroBank' id='b2'><li><a class='dropdown-item' href='#'>2</a></li></div>
								<div class='myMacroBank' id='b3'><li><a class='dropdown-item' href='#'>3</a></li></div>
								<div class='myMacroBank' id='b4'><li><a class='dropdown-item' href='#'>4</a></li></div>
							</div>
			            </div>
				    </span>
				</div>
		...
		<div class="row">
			<div class="col-6 col-sm-2 text-center text-spacer">
