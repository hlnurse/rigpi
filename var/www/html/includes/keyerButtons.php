				<div class="row">
					...
					<tr>
						...
						<td colspan="2">
							<span class="btn-small-color" id="myKeyerSpeedVal" style="font-size: 15px; margin-top: 20px; ">
										0
							</span>
								<div  title='Keyer Speed Adjust' class="slidecontainerSpeed">
									<div id="sliderSpeed" style="margin-top: 4px; background: black;"></div>
								</div>
						</td>
					</tr>
					<tr>
