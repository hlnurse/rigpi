...
<body class="body-black" >
	...
	<div class="container-fluid">
       ...
       $call
     ); ?>" id="callValue" placeholder="Enter your callsign" title="Callsign for this account, need not be unique" aria-lable="call" aria-describedby="call-addon" autofocus>
				</div>
			</div>
			<div class="col-md-4 text-spacer">
				<div class="input-group">
       ...
       $rpiUser
     ); ?>" id="userValue" aria-lable="user"  placeholder="Enter username" title="Unique username for this account" aria-describedby="user-addon">
				</div>
			</div>
			<div class="col-md-4 text-spacer">
				<div class="input-group">
       ...
       $fName
			...
			<div class="col-md-4 text-spacer">
				<div class="input-group">
					...
					<input type="text" class="form-control"  value="<?php echo htmlentities(
       $state
     ); ?>" id="stateValue"  placeholder="Your state 2-letter abbrev (if applicable)" title="Account owner's home state" aria-lable="rsts" aria-describedby="rsts-addon">
				</div>
			</div>
			<div class="col-md-4 text-spacer">
				<div class="input-group">
