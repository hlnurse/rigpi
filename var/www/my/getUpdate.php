...
switch ($tPortion){
	case "1": //download
		if ($tBeta==0){
			...
			$file = "https://rigpi.net/downloads/beta/RigPiUpdates.zip";
		}
	...
	case "2": //unzip
		...
		if ($res === TRUE) {
		    ...
		    echo "Error: Couldn't unzip $file<br>";
		    exit;
		};
		break;
	case "3":  
		...
		break;
	case "4":
		echo "<p>RSS has received the update files.<p><p>Check out the What's New topic in RigPi Help to see what has changed.<p><p><h2>OK to reboot RSS to refresh all files?</h2>";
		break;
