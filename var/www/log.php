...
////////////////////////
            ...
            $('#ulresult').html('');
                ...
                if(!!filel.match(/.*\.adi$/)){
                    ...
                    $("#input_file").val('').prop('disabled',false);
							$("#modalA-body").html(file.name+" is not an ADIF file!");			  				
    ...
    $(document).on('click', '.export', function() {
		...
		if (confirm(tAsk)){
			...
			$.post("./programs/exportADIF.php",{sel:0,log:tF,call:tMyCall,type:'full',uid:tUser}, function(response){
				if (response=="0"){
					$('#dlresult').html("No records found to export.");
					getDownloadCount=0;
				}else{
				...
				$('#dlresult').html("ADIF download: "+response);
			})
		}
	})
	...
	$(document).on('click', '#next', function() {
		...
		if (curPage>pageCount){
			curPage=pageCount;
			$("#modalA-body").html("Already xxxviewing last page (of "+pageCount+").");			  				
...
//			alert("Already viewing last page (of "+pageCount+").");
	...
	$(document).on('click', '#previous', function() {
		...
		if (curPage<1){
			curPage=1;
			$("#modalA-body").html("Already yyyviewing first page (of "+pageCount+").");			  				
			$("#modalA-title").html("Log Navigate");
		  	$("#myModalAlert").modal({show:true});
		  	return;
		}
...
<body class="body-black" id="log">
	    ...
	    <div class="modal-dialog" role="document">
	    	<div class="modal-content">
				<div class="modal-header">
					<h2 class="modal-title">Upload/Import ADIF</h2>
	...
	<div class="modal fade" id="downloadModal" tabindex="-1" role="dialog">
	    <div class="modal-dialog" role="document">
	    	<div class="modal-content">
				<div class="modal-header">
					<h2 class="dlmodal-title">Export/Download ADIF</h2>
